#
#  Be sure to run `pod spec lint DEStackView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.screenshots  = "https://github.com/DAEUN28/DEStackView/example.png"
  ...
  # Or just: spec.author    = "DAEUN28"
  # spec.authors            = { "DAEUN28" => "acone1128@gmail.com" }
